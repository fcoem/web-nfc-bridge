...
// works with both PCSCDriver (*scard.Card) and DirectDriver.
...
func readType2Capability(card CardTransmitter) (*type2Capability, error) {
...
func readType2Pages(card CardTransmitter, startPage int, length int) ([]byte, error) {
...
func writeType2Pages(card CardTransmitter, startPage int, payload []byte) error {
...
func verifyType2Write(card CardTransmitter, expected []byte) error {
...
func readType2Range(card CardTransmitter, startPage int, totalBytes int) ([]byte, error) {
...
func readType2PagesWithFallback(card CardTransmitter, startPage int, length int) ([]byte, error) {
